...
<br>
    <form class="" action="" method="post">
      <p class="text-danger">Esta seguro que quiere eliminar esta pelicula?</p>
      <input class="btn btn-danger" type="submit" name="borrar" value="si">
      <input class="btn btn-danger" type="submit" name="no" value="no">
      <input type="hidden" name="id" value="<?=$id_pelicula;?>">
   </form>
